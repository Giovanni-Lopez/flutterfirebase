...
import 'package:flutterfirebase/widget/page_view.dart';
...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      routes: {
        'grid': ((context) => const GridContainer()),
        'page_view': (_) =>   Page_View(),
      },
...
class _MyHomePageState extends State<MyHomePage> {
  ...
  void initState() {
    super.initState();
    //Llamamos el metodo para ver los datos
    getProducts();
    getusuario();
  }


//Para obtener los datos de FireBase
